...
\centering
\caption{Esquema de uma rede neural convoluciona. Número de filtros e camadas arbitrários para melhor representação. Diagrama feito em \url{http://alexlenail.me/NN-SVG/LeNet.html}}
\end{figure}
...
Isso é possível em domínios simples, como um Jogo da Velha ou um \textit{Gridworld}, mas se torna impraticável conforme o espaço de estados aumenta.
