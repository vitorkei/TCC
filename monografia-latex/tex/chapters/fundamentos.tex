...
Uma vez que a política é gulosa, o agente sempre tomará a ação que retorna a maior recompensa imediata.
...
Como as imagens passadas não são rotuladas, a IA precisa encontrar outra forma de calcular o erro da saída da rede.
